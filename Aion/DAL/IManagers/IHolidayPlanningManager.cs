...
namespace Aion.DAL.Managers
{
    public interface IHolidayPlanningManager
    {
        ...
        Task<List<vw_HolidayPlanningStore>> GetHolidayChain(string chain, int startWeek, int endWeek);
        ...
        Task<List<vw_HolidayPlanningRollup>> GetHolidayChainRollup(string chain, int startWeek);
    }
}